      ...
      translation: {
        ...
        liveEdit: {
          ...
          labels: {
            ...
            liveType: 'ライブの種類',
            artistName: 'アーティスト名',
            playerOrTeam: '選手 / チーム名',
            playerPhoto: '選手 / 球団の写真',
            date: '日付',
            startTime: '開始時間',
            endTime: '終了時間',
            venue: '会場',
          ...
          placeholders: {
            ...
            playerOrTeam: '例: 大谷翔平 / 読売ジャイアンツ',
            venue: '例: 東京ドーム',
            platform: '例: ZAIKO / ABEMA / Stagecrowd / YouTube',
            seat: '例: アリーナA-10',
            sportsSeat: '例: 外野自由席 Aブロック',
          ...
          liveTypes: ['ワンマン', '対バン', 'フェス', 'FC限定', '配信', 'スポーツ観戦'],
          songInput: {
            special: {
              encore: '📣 アンコール区切りを追加',
              mc: '🎙️ MC / トークを追加',
      ...
      translation: {
        ...
        liveEdit: {
          ...
          placeholders: {
            ...
            playerOrTeam: 'e.g. Shohei Ohtani / Yomiuri Giants',
            venue: 'e.g. Tokyo Dome',
            platform: 'e.g. ZAIKO / ABEMA / Stagecrowd / YouTube',
            seat: 'e.g. Arena A-10',
            sportsSeat: 'e.g. Left Field Block A',
          ...
          liveTypes: ['One-man', 'Two-man', 'Festival', 'FC Only', 'Streaming', 'Sports'],
          songInput: {
            special: {
